...
{
  // arrays
  PROB_TYPE *cP;                      // conditionalProb array
  PROB_TYPE *iP;                      // initialProb array
  PROB_TYPE *eP;                      // endProb array
  PROB_TYPE *len;                     // length array
  // sizes of the arrays
...
/*
 * This function copies the content of the nGram_struct @comen to
